...
Ask questions about this site and your public GitHub project catalog.
Responses are grounded in local site content and project metadata.
...
<div class="jp-ask-shell">
  ...
  <textarea
    ...
    class="jp-ask-input"
    rows="5"
    placeholder="Example: Which repositories focus on automation and infrastructure?"
